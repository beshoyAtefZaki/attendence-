...
import frappe
from erpnext.hr.doctype.employee.employee import OverlapError
from erpnext.hr.doctype.employee_attendance_tool.employee_attendance_tool import check_assigned_period
...
class Permission(Document):
	...
	def validate_dates(self):
		...
		if permission_based_on == "Number Of Permissions Per Month":
			if flt(self.permission_balance) < 1.0:
	...
	def validate_attendance_period(self):
		dict_period = check_assigned_period(self.employee,self.for_date)
		if not dict_period:
